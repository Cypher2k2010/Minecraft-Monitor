...
class minecraft
{
	...
	{
		$this->pipein = PIPE_PATH."/mmpipein";
		$this->pipeout = PIPE_PATH."/mmpipeout";
	}
...
class player
{
	...
	public function delete()
	{
		...
		unlink(MINECRAFT_PATH."/".$properties['level-name']."/players/".ereg_replace("[^A-Za-z0-9\_]", "", $this->handle ).".dat");
	}
}

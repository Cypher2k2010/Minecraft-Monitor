<?php
	...
	*/	
	...
	//Config String Start	
	$json_settings = '{"MINECRAFT_PATH":".\/minecraft","SERVER_PASS":"","LOG_LINES":40,"CENTRAL_UPDATE":false,"UPDATE_SELF":false,"UPDATE_MINECRAFT":true,"MINECRAFT_BIN":"minecraft-server.jar","TEAMSPEAK_BIN":"\/proc\/net\/dev","NETDEV_PATH":"\/proc\/net\/dev","CPU_PATH":"\/proc\/cpuinfo","LOAD_PATH":"\/proc\/loadavg","MONITOR_HANDLE":"","JAVA_PATH":"java\/"}';
	//Config String End
